...
void Draw(struct Record* records,int prm)
{
...
int main()
{
	...
	// Добавить новую запись (элемент массива структур), содержащие максимальные
	// числовые значения в столбцах
	records[3] = { "Мин", "М", 0, 0, {01,01,2000} };
	Draw(records,4);
